...
```{r}
knitr::include_graphics("../images/infrastructure/medium/cyclelane.jpg")
```
...
```{r}
knitr::include_graphics("../images/infrastructure/medium/lightsegregation.jpg")
```
...
```{r}
knitr::include_graphics("../images/infrastructure/medium/steppedtrack.jpg")
```
...
```{r}
knitr::include_graphics("../images/infrastructure/medium/regregatedtrack.jpg")
```
...
```{r}
knitr::include_graphics("../images/infrastructure/medium/cyclestreet.jpg")
```
