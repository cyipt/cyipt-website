...
If you find any issues on this user manual, for example, please make suggested changes to the source code [here](https://github.com/cyipt/cyipt-website/edit/master/man/index.Rmd) (requires a GitHub username).
